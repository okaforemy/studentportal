...
export default {
    ...
    data(){
        return{
            form: this.$inertia.form({
                ...
                home_adddress:  this.Parent.homeAdddress,
                office_adddress:this.Parent.officeAdddress,
                email:          this.Parent.email,
                phone:          this.Parent.phone,
                id:             this.Parent.id,
                isparent:       this.Parent.isparent,
            }),
            result:{},
            parent_type:{
                father:'Father',
    ...
    methods:{
        submit(){
            this.$inertia.post('/edit-parent-only',this.form,{
                onSuccess: (response)=>{
