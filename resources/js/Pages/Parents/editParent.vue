        ...
        <div class="pt-3">
            ...
            <div class="col-md-8">
                <div class="card ">
                    ...
                    <h3 class="card-title">Edit {{form.isparent}}'s details for <strong v-if="surname">{{surname+" "+othernames}}</strong> </h3>
                    </div>
                    <div class="card-body">
                 ...
                 <div class="card">
                    ...
                    <!-- /.card-header -->
                     <div class="card-body table-sm-responsive p-0">
                        <table class="table">
                            <tr>
                                <td v-if="ismother=='mother'">
                                    <Link href="/edit-parent"  :data="{id:student_id,surname:surname, othernames:othernames,parent_id:mother[0].id}">Edit Mother's details</Link>
                                 
                                </td>
                                <td v-else>
                                   <Link href="/add-parents" :data="{id:student_id,surname:surname, othernames:othernames}"> Add Mother's details </Link>
                                </td>
                            </tr>
                            <tr>
                                <td v-if="isfather=='father'">
                                   <Link href="/edit-parent" :data="{id:student_id,surname:surname, othernames:othernames, parent_id:father[0].id}"> Edit Father's details</Link>
                                  
                                </td>
                                <td v-else>
                                    <Link href="/add-parents" :data="{id:student_id,surname:surname, othernames:othernames}">Add Father's details</Link>
                                </td>
                           </tr>
                           <tr>
                                <td v-if="isguardian=='guardian'">
                                   <Link href="/edit-parent" :data="{id:student_id,surname:surname, othernames:othernames, parent_id:guardian[0].id}"> Edit Guardian's details</Link>
                                </td>
                                <td v-else>
                                    <Link href="/add-parents" :data="{id:student_id,surname:surname, othernames:othernames}">Add Guardian's details</Link>
                                </td>
                           </tr>
                        </table>
                    </div>
...
export default {
    ...
    methods:{
        submit(){
            ...
            this.$inertia.post('/edit-parent',this.form,{
                onSuccess: (response)=>{
                   this.form = this.$inertia.form({
                     ...
                     toastr.success('Parent edited successfully!', 'Success')
                }
            });
        },
        search(input) {
    ...
    created(){
       this.form=this.$inertia.form(this.Parent[0])
       this.form['std_id'] = this.student_id;
    }
}
</script>