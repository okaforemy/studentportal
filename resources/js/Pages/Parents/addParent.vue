        ...
        <div class="pt-3">
            ...
            <div class="col-md-8">
                <div class="card ">
                    ...
                    <h3 class="card-title">Add Parent/Guardian for <strong v-if="surname">{{surname+" "+othernames}}</strong> </h3>
                    </div>
                    <div class="card-body">
...
export default {
    ...
    methods:{
        submit(){
            ...
            this.$inertia.post('/add-parents',this.form,{
                onSuccess: (response)=>{
